...
export const ENDPOINT_CUSTOMERS      = 'customers/api/v1/customers{/customerId}'
export const ENDPOINT_ACCOUNTS       = 'bank/api/v1/accounts{/customerId}{/accountNumber}'
export const ENDPOINT_TRANSACTIONS   = 'bank/api/v1/transactions{/customerId}{/accountNumber}'
export const ENDPOINT_TRANSFERS      = 'bank/api/v1/transfers{/customerId}'
